  ...
  <html lang="en">
      ...
      <body>
          ...
          <section class="banner">
            <img class="accbanner" src="/banners/{{ auth()->user()->banner }}" alt="">
        </section>
          ...
          <div class="data">
            ...
            <form action="/logout"><button class="logout">Log Out  <ion-icon name="exit-sharp" class="exit"></ion-icon></button></form>
          </div>
          </section>
